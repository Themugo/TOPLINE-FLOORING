...
import { getCustomerLifecycleOperations360, reconcileCustomerLifecycle360, type CustomerLifecycleCustomer } from '@/lib/customer-lifecycle-360';

type Row = CustomerLifecycleCustomer;
