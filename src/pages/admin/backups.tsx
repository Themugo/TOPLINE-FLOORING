...
export default function AdminBackups() {
  ...
  return <AdminLayout><div className="space-y-6 max-w-4xl"><div><h1 className="text-2xl font-bold">Backups & Data Export</h1><p className="text-muted-foreground">Understand the database backup boundary and create an operational data export.</p></div>
    <div className="grid md:grid-cols-2 gap-6"><div className="rounded-lg border bg-card p-6"><ShieldCheck className="h-7 w-7 text-green-600 mb-4"/><h2 className="font-semibold">Database backups</h2><p className="text-sm text-muted-foreground mt-2">PostgreSQL backups are managed by Supabase. Topline does not pretend to create a second database backup from the browser.</p><a className="text-sm text-primary hover:underline mt-4 inline-block" href="https://supabase.com/dashboard/project/zmbsskvnzjdaxuxlauyx/settings/database" target="_blank" rel="noreferrer">Open Supabase database settings</a></div>
