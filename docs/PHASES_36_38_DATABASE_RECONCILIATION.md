...
The canonical repository currently contains **73 active migrations**, with a static inventory of **142 tables and 213 functions**. These figures describe the repository migration chain, not the live remote database.
