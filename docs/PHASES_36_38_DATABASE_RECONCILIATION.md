...
The canonical repository currently contains **80 active migrations**, with a static inventory of **142 tables and 214 functions**. These figures describe the repository migration chain, not the live remote database.
