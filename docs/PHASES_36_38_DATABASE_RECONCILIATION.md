...
The canonical repository currently contains **40 active migrations**, with a static inventory of **107 tables and 119 functions**. These figures describe the repository migration chain, not the live remote database.
