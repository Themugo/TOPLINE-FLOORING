...
const migration = path.join(root, 'supabase', 'migrations', '20260912030000_production_infrastructure_rls_storage.sql');
...
if (!fs.readFileSync(manifest, 'utf8').includes('20260912030000_production_infrastructure_rls_storage.sql')) throw new Error('Migration manifest is missing Phase 2 migration');
