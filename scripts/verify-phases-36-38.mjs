...
if (migrations.length < 80) failures.push(`Expected at least 80 active migrations, found ${migrations.length}.`);
...
for (const requiredText of ['80 active migrations', '142 tables', '214 functions', 'db push --dry-run --linked', 'Never run `supabase db reset --linked`']) {
