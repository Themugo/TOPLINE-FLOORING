...
if (!envExample.includes('jypkhvknfgoqrhwzbdwi.supabase.co')) throw new Error('Topline Supabase URL missing from environment contract.');
...
if (!supabase.includes('jypkhvknfgoqrhwzbdwi.supabase.co')) throw new Error('Supabase client is not pinned to Topline.');
