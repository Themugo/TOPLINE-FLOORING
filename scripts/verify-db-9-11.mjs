...
if(!read('supabase/MIGRATION_MANIFEST.md').includes('80 uniquely timestamped active migrations')) fail.push('Migration manifest does not declare 80 active migrations.');
