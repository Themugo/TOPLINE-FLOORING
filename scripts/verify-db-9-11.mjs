...
if(!read('supabase/MIGRATION_MANIFEST.md').includes('82 uniquely timestamped active migrations')) fail.push('Migration manifest does not declare 82 active migrations.');
