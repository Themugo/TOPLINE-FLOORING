...
if(!read('supabase/MIGRATION_MANIFEST.md').includes('84 uniquely timestamped active migrations')) fail.push('Migration manifest does not declare 84 active migrations.');
